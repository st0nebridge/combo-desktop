<!-- filepath: m:\Dev\Tools\combo-desktop\rules\compressed\source_files.md\pcs_source_files.L2.md -->
# PCS L2: Source File Organization Reference

**📊 Compression Metadata:**
- Level: L2 (Operational Reference)
- Source: `../source_files.md`
- Timestamp: 2025-06-10
- Token Reduction: ~55%
- Preservation: Core requirements (100%), structure (100%)

**🔗 Navigation:** [Source](../source_files.md)
